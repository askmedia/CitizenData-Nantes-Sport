	...
	<div class="wrapper__intro">
        <div class="wrapper__intro__body">
            <div class="wrapper__intro__body__inner">
                ...
                <p>
					La diffusion des données ou <em>data</em> publiques s’accélère. Dans le sillage de plusieurs métropoles - Paris, Rennes ou Nantes – les institutions nationales et locales semblent aujourd’hui convaincues de l’avancée démocratique que représente l’open data.<br />
